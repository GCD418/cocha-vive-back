...
public interface TicketMapper {
    ...
    @Mapping(target = "eventCategoryName", source = "event.category.name")
    @Mapping(target = "eventDateStart", source = "event.dateStart")
    @Mapping(target = "eventDateEnd", source = "event.dateEnd")
